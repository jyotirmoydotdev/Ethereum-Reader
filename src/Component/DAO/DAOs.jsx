...
function DAOs() {
  ...
  return (
    <div>
        <div className="grid dark:text-white xl:grid-cols-4 lg:grid-cols-3 sm:grid-cols-2 grid-cols-1 overflow-auto gap-3"style={{height: "45rem"}}>
            {datas.data.map((el,i)=>(
             <div className="shadow-sm border border-1 dark:border-gray-600 bg-white  hover:bg-gray-200 dark:hover:bg-gray-700 dark:bg-gray-800  dark:shadow-gray-500 flex flex-row  overflow-auto rounded-xl h-28 gap-2 p-3 m-2 mt-0" key={i+1}>
              ...
              <div className="w-full flex flex-col justify-center items-center ">
                ...
                <svg viewBox="0 0 24 24" width="1em" height="1em" class="text-[23px]"><path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M21 12a9 9 0 0 1-9 9m9-9a9 9 0 0 0-9-9m9 9H3m9 9a9 9 0 0 1-9-9m9 9c1.657 0 3-4.03 3-9s-1.343-9-3-9m0 18c-1.657 0-3-4.03-3-9s1.343-9 3-9m-9 9a9 9 0 0 1 9-9"></path></svg>
                <div className="px-2 rounded-md font-semibold text-white text-sm bg-blue-400 ">
